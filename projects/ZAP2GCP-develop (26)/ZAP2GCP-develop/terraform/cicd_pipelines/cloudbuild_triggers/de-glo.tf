...
resource "google_cloudbuild_trigger" "dev_trigger_de_glo" {
  project     = var.project_id
  name        = "cb-de-glo-d-dbx-trigger"
  description = "Trigger for de-glo repository in dev env"
  github {
    name  = "ZAP2GCP-DE-GLO"
  ...
  tags = ["ZAP2GCP-DE-GLO", "dl-glo", "dev"]
...
resource "google_cloudbuild_trigger" "test_trigger_de_glo" {
  project     = var.project_id
  name        = "cb-de-glo-t-dbx-trigger"
  description = "Trigger for de-glo repository in test env"
  github {
    name  = "ZAP2GCP-DE-GLO"
    owner = "zebratechnologies"
    push {
  ...
  tags = ["ZAP2GCP-DE-GLO", "de-glo", "test"]
...
*********************************************************/
/*
resource "google_cloudbuild_trigger" "prod_trigger_de_glo" {
  project     = var.project_id
  name        = "cb-de-glo-p-dbx-trigger"
  description = "Trigger for de-glo repository in prod env"
  github {
    name  = "ZAP2GCP-DE-GLO"
    owner = "zebratechnologies"
    push {
  ...
  tags = ["ZAP2GCP-DE-GLO", "de-glo", "prod"]
  lifecycle {
...
resource "google_cloudbuild_trigger" "prod_rollback_trigger_de_glo" {
  project     = var.project_id
  name        = "cb-de-glo-p-rollback-dbx-trigger "
  description = "Trigger for de-glo repository for rollback in prod env"
  ...
  tags = ["ZAP2GCP-DE-GLO", "de-glo", "prod", "rollback"]
  lifecycle {
    ignore_changes = [github]
  }
