...
resource "google_cloudbuild_trigger" "dev_trigger_sp" {
  project     = var.project_id
  name        = "cb-sharepoint-d-dbx-trigger"
  description = "Trigger for sharepoint repository in dev env"
  github {
    name  = "ZAP2GCP-DE-SharePoint"
  ...
  tags = ["ZAP2GCP-DE-SharePoint", "sharepoint", "dev"]
  ...
  substitutions = {
    ...
    _REPO_NAME      = "ZAP2GCP-DE-SharePoint"
...
resource "google_cloudbuild_trigger" "test_trigger_sp" {
  project     = var.project_id
  name        = "cb-sharepoint-t-dbx-trigger"
  description = "Trigger for sharepoint repository in test env"
  github {
    name  = "ZAP2GCP-DE-SharePoint"
    owner = "zebratechnologies"
    push {
  ...
  tags = ["ZAP2GCP-DE-SharePoint", "sharepoint", "test"]
...
resource "google_cloudbuild_trigger" "prod_trigger_sp" {
  project     = var.project_id
  name        = "cb-sharepoint-p-dbx-trigger"
  description = "Trigger for sharepoint repository in prod env"
  github {
    name  = "ZAP2GCP-DE-SharePoint"
    owner = "zebratechnologies"
    push {
  ...
  tags = ["ZAP2GCP-DE-SharePoint", "sharepoint", "prod"]
  lifecycle {
...
*********************************************************/
/*
resource "google_cloudbuild_trigger" "prod_rollback_trigger_sharepoint" {
  project     = var.project_id
  name        = "cb-sharepoint-p-rollback-dbx-trigger "
  description = "Trigger for sharepoint repository for rollback in prod env"
  ...
  tags = ["ZAP2GCP-DE-SharePoint", "sharepoint", "prod", "rollback"]
  lifecycle {
    ignore_changes = [github]
  }
