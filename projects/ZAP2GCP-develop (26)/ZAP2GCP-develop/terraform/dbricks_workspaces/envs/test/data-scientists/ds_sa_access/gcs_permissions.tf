...
# DEV Environment :- its-managed-dbx-ds-01-t
# Permissions: 
...
sa-gke-gcs-ds-object-admin@its-managed-dbx-ds-01-t.iam.gserviceaccount.com	
sa-glo-gke-dbx@its-managed-dbx-ds-01-t.iam.gserviceaccount.com
...
sa-sql-endpoint-ds-t@its-managed-dbx-ds-01-t.iam.gserviceaccount.com" 
...
resource "google_service_account" "sql_endpoint_ds_test_sa" {
  project      = var.project_id
  account_id   = "sa-sql-endpoint-ds-t" #Prod service account id name for object reader access
  display_name = "Data Science TEST Service Account for SQL Endpoint"
}

resource "google_project_iam_member" "sql_endpoint_ds_test_sa_admin" {
  project = var.project_id
  role    = "roles/storage.objectAdmin"
  member  = "serviceAccount:sa-sql-endpoint-ds-t@its-managed-dbx-ds-01-t.iam.gserviceaccount.com"
  depends_on = [
    google_service_account.sql_endpoint_ds_test_sa
  ]
}

resource "google_project_iam_member" "sql_endpoint_ds_test_sa_de_admin" {
  project = "its-managed-dbx-de-01-t"
  role    = "roles/storage.objectAdmin"
  member  = "serviceAccount:sa-sql-endpoint-ds-t@its-managed-dbx-ds-01-t.iam.gserviceaccount.com"
  depends_on = [
    google_service_account.sql_endpoint_ds_test_sa
...
resource "google_storage_bucket_iam_member" "databricks_2348922014507522_bucket_adm" {
...
resource "google_storage_bucket_iam_member" "databricks_2348922014507522_bucket_read" {
  bucket = data.google_storage_bucket.databricks_2348922014507522.name
...
resource "google_storage_bucket_iam_member" "databricks_2348922014507522_system_adm" {
...
resource "google_storage_bucket_iam_member" "databricks_2348922014507522_system_read" {
  bucket = data.google_storage_bucket.databricks_2348922014507522_system.name
  role = "roles/storage.objectViewer"
  for_each = toset([
      "group:gcds-its-zap-glo-ds-developers@zebra.com",
