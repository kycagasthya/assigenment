...
variable "region" {
  description = "The region  where the instance template should be created."
  type        = string
}
...
variable "cloudsql_bin_path" {
  description = "Path for cloud sql proxy."
  type        = string
}

variable "instance_tmplt_prefix" {
  description = "Instance template prefix."
  type        = string
}
...
variable "disk_labels" {
  description = "Labels to be assigned to boot disk."
  type        = map(string)
}
...
variable "mig_labels" {
  description = "Labels for managed instance groups."
  type        = map(string)
}


variable "inst_tmplt_tags" {
  description = "Tags attached for instance templates."
  type        = list(string)
}

variable "mig_name" {
  description = "Managed instance group name. When variable is empty."
  type        = string
}
...
variable "distribution_policy_zones" {
  description = "The distribution policy, i.e. which zone(s) should instances be create in."
  type        = list(string)
}
