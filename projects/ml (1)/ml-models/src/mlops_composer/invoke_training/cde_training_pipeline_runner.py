...
"""This is the pipeline runner for cde processor training"""
...
def train(config_dict):
    ...
    try:
        ...
        if (not config_dict.get("config_path", 0)) or config_dict.get(
            "config_path") == "":
            config_path = f"{parent_dir}/config/config_{stage}/cde_config.json"
        else:
        ...
        pipeline_job = aiplatform.PipelineJob(
            ...
            display_name="cde-train-pipeline",
