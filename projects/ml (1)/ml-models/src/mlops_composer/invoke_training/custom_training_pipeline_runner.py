...
"""This is the pipeline runner for custom od model"""
...
def train(config_dict):
    ...
    try:
        ...
        if (not config_dict.get("config_path", 0)) or config_dict.get(
            "config_path") == "":
            config_path = f"{parent_dir}/config/" \
            f"config_{stage}/custom_od_config.json"
        else:
        ...
        pipeline_job = aiplatform.PipelineJob(
            ...
            display_name="custom-od-train-pipeline",
