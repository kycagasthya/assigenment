...
"""This module will perform training for cdc processor"""
...
def lro(lro_name: str, location: str, check_status_after: str):
    ...
    Args:
        ...
        location (str): location of the processor
        check_status_after (str): time interval in milliseconds after
...
def cdc_train(project_number : str,
              processor_id : str,
              version : str,
              location : str,
    ...
    """
    logger("INFO", "Training", "Entering in training component for CDC")
