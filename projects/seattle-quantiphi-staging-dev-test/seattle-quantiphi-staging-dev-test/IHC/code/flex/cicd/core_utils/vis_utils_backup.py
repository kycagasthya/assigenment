...
import os
import gc
def get_overlay_objects(
    slide_name, all_csv_paths, all_slide_paths, output_dir,
    label_dir="/home/jupyter/seattle-quantiphi/viz_tutorial/csvs/gt_labels",
    plot_size=1920, return_label_object=True):
...
def return_path_dirs(
    ...
    path_to_no_tissue_dir = "/home/jupyter/seattle-quantiphi/data/Tissue/No_Tissue",
...
class OverlayTool:
    ...
    def __init__(
        self, df, output_dir, path_to_slide, cmap_name, 
    ...
    def plot_merged(self, fig_multiplier=20, bg_opacity=0.65, gt_slide_label=None, subregion=None, save_to_dir=None):
        ...
        if save_to_dir is not None:
            plt.savefig(os.path.join(save_to_dir, "color_maps", self.path_to_slide.rsplit("/", 1)[1].split(".")[0]+".png"), dpi=150)
    ...
    def plot_slide_only(self, fig_multiplier=20, gt_slide_label=None, subregion=None, save_to_dir=None):
        ...
        if save_to_dir is not None:
            plt.savefig(os.path.join(save_to_dir, "slide_only", self.path_to_slide.rsplit("/", 1)[1].split(".")[0]+".png"), dpi=150)
